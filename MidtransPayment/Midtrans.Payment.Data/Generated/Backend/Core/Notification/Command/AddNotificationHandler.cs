...
namespace Midtrans.Payment.Core.Notification.Command
{
    ...
    public class AddNotificationRequest :NotificationRequest, IMapRequest<Midtrans.Payment.Data.Model.Notification, AddNotificationRequest>,IRequest<StatusResponse>
    {
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<AddNotificationRequest, Midtrans.Payment.Data.Model.Notification> map)
        {
    ...
    internal class AddNotificationHandler : IRequestHandler<AddNotificationRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(AddNotificationRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var data = _mapper.Map<Midtrans.Payment.Data.Model.Notification>(request);
