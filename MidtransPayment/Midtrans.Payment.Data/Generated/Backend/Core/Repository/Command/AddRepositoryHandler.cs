...
namespace Midtrans.Payment.Core.Repository.Command
{
    ...
    public class AddRepositoryRequest :RepositoryRequest, IMapRequest<Midtrans.Payment.Data.Model.Repository, AddRepositoryRequest>,IRequest<StatusResponse>
    {
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<AddRepositoryRequest, Midtrans.Payment.Data.Model.Repository> map)
        {
    ...
    internal class AddRepositoryHandler : IRequestHandler<AddRepositoryRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(AddRepositoryRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var data = _mapper.Map<Midtrans.Payment.Data.Model.Repository>(request);
