...
{
    public partial class UserResponse: IMapResponse<UserResponse, Midtrans.Payment.Data.Model.User>
    {
        ...
        public void Mapping(IMappingExpression<Midtrans.Payment.Data.Model.User, UserResponse> map)
        {
